...
#define x264_quant_4x4_mmx x264_template(quant_4x4_mmx)
int x264_quant_4x4_mmx( dctcoef dct[16], udctcoef mf[16], udctcoef bias[16] );
#define x264_quant_4x4x4_mmx x264_template(quant_4x4x4_mmx)
int x264_quant_4x4x4_mmx( dctcoef dct[4][16], udctcoef mf[16], udctcoef bias[16] );
#define x264_quant_8x8_mmx x264_template(quant_8x8_mmx)
...
#define x264_decimate_score15_mmx2 x264_template(decimate_score15_mmx2)
...
#define x264_decimate_score16_mmx2 x264_template(decimate_score16_mmx2)
...
#define x264_decimate_score64_mmx2 x264_template(decimate_score64_mmx2)
