...
#define x264_predict_16x16_dc_mmx2 x264_template(predict_16x16_dc_mmx2)
...
#define x264_predict_16x16_dc_core_avx2 x264_template(predict_16x16_dc_core_avx2)
void x264_predict_16x16_dc_core_avx2( pixel *src, int i_dc_left );
#define x264_predict_16x16_dc_left_core_mmx2 x264_template(predict_16x16_dc_left_core_mmx2)
void x264_predict_16x16_dc_left_core_mmx2( pixel *src, int i_dc_left );
#define x264_predict_16x16_dc_left_core_sse2 x264_template(predict_16x16_dc_left_core_sse2)
void x264_predict_16x16_dc_left_core_sse2( pixel *src, int i_dc_left );
#define x264_predict_16x16_dc_left_core_avx2 x264_template(predict_16x16_dc_left_core_avx2)
void x264_predict_16x16_dc_left_core_avx2( pixel *src, int i_dc_left );
#define x264_predict_16x16_dc_top_mmx2 x264_template(predict_16x16_dc_top_mmx2)
...
#define x264_predict_8x8_ddl_ssse3_cache64 x264_template(predict_8x8_ddl_ssse3_cache64)
...
#define x264_predict_8x8_ddr_ssse3_cache64 x264_template(predict_8x8_ddr_ssse3_cache64)
...
#define x264_predict_4x4_vr_ssse3_cache64 x264_template(predict_4x4_vr_ssse3_cache64)
