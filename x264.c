...
/* No longer available via common/common.h (bit-depth dependent, and this
 * file compiles once regardless of which depth(s) are selected) -- use the
 * widest possible range (10-bit) for CLI help text/QP validation. */
...
#endif
    printf( "configuration: --bit-depth=%s --chroma-format=%s\n",
        ...
        "none",
#endif
        X264_CHROMA_FORMAT ? (output_csp_names[0]+1) : "all" );
    printf( "x264 license: " );
#if HAVE_GPL
